...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			// btnZaloguj
			// 
			this->btnZaloguj->Location = System::Drawing::Point(305, 26);
			...
			// btnAnuluj
			// 
			this->btnAnuluj->Location = System::Drawing::Point(305, 74);
			...
			this->label1->Location = System::Drawing::Point(58, 29);
			...
			// txtUzytkownik
			// 
			this->txtUzytkownik->Location = System::Drawing::Point(160, 26);
			...
			// txtHaslo
			// 
			this->txtHaslo->Location = System::Drawing::Point(160, 77);
			...
			this->ClientSize = System::Drawing::Size(486, 128);
...
#pragma endregion
	...
	private: System::Void btnZaloguj_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			...
			if (odczytanie->Read()) {
				float id_uzytkownik = odczytanie->GetInt32(0);
				this->Hide();
